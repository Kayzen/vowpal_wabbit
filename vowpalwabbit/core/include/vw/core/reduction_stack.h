...
{
public:
  default_reduction_stack_setup(VW980::workspace& all, VW980::config::options_i& options);
  ...
  std::shared_ptr<VW980::LEARNER::learner> setup_base_learner(size_t increment = 1) override;
...
private:
  ...
  std::shared_ptr<VW980::LEARNER::learner> _base;
