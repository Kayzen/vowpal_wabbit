...
TEST(Las, CheckMetricsWithLASRunsOK)
{
  ...
  examples.push_back(VW980::read_example(*vw, "1:1:0.1 | 1:0.1 2:0.12 3:0.13"));
...
TEST(Las, CheckAOSameActionsSameRepresentation)
{
  ...
  for (auto& vw_ptr : vws)
  {
...

    {
      ...
      examples.push_back(VW980::read_example(vw, "shared |U b c"));
      examples.push_back(VW980::read_example(vw, "|A 1:0.1 2:0.12 3:0.13 b200:2 c500:9"));
      // duplicates start
      examples.push_back(VW980::read_example(vw, "|A a_1:0.5 a_2:0.65 a_3:0.12 a100:4 a200:33"));
      examples.push_back(VW980::read_example(vw, "|A a_1:0.5 a_2:0.65 a_3:0.12 a100:4 a200:33"));
      // duplicates end
      examples.push_back(VW980::read_example(vw, "|A a_4:0.8 a_5:0.32 a_6:0.15 d1:0.2 d10:0.2"));
      examples.push_back(VW980::read_example(vw, "|A a_7 a_8 a_9 v1:0.99"));
      examples.push_back(VW980::read_example(vw, "|A a_10 a_11 a_12"));
      examples.push_back(VW980::read_example(vw, "|A a_13 a_14 a_15"));
      examples.push_back(VW980::read_example(vw, "|A a_16 a_17 a_18:0.2"));
...
TEST(Las, CheckAOLinearCombinationOfActions)
{
  ...
  for (auto& vw_ptr : vws)
  {
...

    {
      ...
      examples.push_back(VW980::read_example(vw, "|A a_1:0.5 a_2:0.65 a_3:0.12 a100:4 a200:33"));
      examples.push_back(VW980::read_example(vw, "|A a_1:0.8 a_2:0.32 a_3:0.15 a100:0.2 a200:0.2"));
      // linear combination of the above two actions
      // action_4 = action_2 + 2 * action_3
      examples.push_back(VW980::read_example(vw, "|A a_1:2.1 a_2:1.29 a_3:0.42 a100:4.4 a200:33.4"));
...

    {
      ...
      examples.push_back(VW980::read_example(vw, "| a_1:0.8 a_2:0.32 a_3:0.15 a100:0.2 a200:0.2"));
      // linear combination of the above two actions
      // action_4 = action_2 + 2 * action_3
      examples.push_back(VW980::read_example(vw, "| a_1:2.1 a_2:1.29 a_3:0.42 a100:4.4 a200:33.4"));
...
TEST(Las, CheckActionCacheWithCB)
{
  ...
  for (const int cache_slack : {50, -1})
  {
...

    {
      ...
      examples.push_back(VW980::read_example(*vw, "| a_13 a_14 a_15"));
      examples.push_back(VW980::read_example(*vw, "| a_16 a_17 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "| a_19 a_20 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "| a_21 a_22 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "| a_23 a_24 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "| a_25 a_26 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "| a_27 a_28 a_18:0.2"));
    ...
    // but make them different order
    {
      ...
      examples.push_back(VW980::read_example(*vw, "shared |A a b"));
      examples.push_back(VW980::read_example(*vw, "| 1:0.1 2:0.12 3:0.13 b200:2 c500:9"));
      examples.push_back(VW980::read_example(*vw, "| a_7 a_8 a_9 v1:0.99"));
      examples.push_back(VW980::read_example(*vw, "| a_10 a_11 a_12"));
      examples.push_back(VW980::read_example(*vw, "| a_13 a_14 a_15"));
...
TEST(Las, CheckActionCacheWithCCB)
{
  ...
  for (const int cache_slack : {50, -1})
  {
...

    {
      ...
      examples.push_back(VW980::read_example(*vw, "ccb shared |U b c"));
      examples.push_back(VW980::read_example(*vw, "ccb action | 1:0.1 2:0.12 3:0.13 b200:2 c500:9"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_1:0.5 a_2:0.65 a_3:0.12 a100:4 a200:33"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_1:0.8 a_2:0.32 a_3:0.15 a100:0.2 a200:0.2"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_1:2.1 a_2:1.29 a_3:0.42 a100:4.4 a200:33.4"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_4:0.8 a_5:0.32 a_6:0.15 d1:0.2 d10: 0.2"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_7 a_8 a_9 v1:0.99"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_10 a_11 a_12"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_13 a_14 a_15"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_16 a_17 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_19 a_20 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_21 a_22 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_23 a_24 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_25 a_26 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_27 a_28 a_18:0.2"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_44:0.8 a_5:0.32 a_6:0.15 d1:0.2 d10: 0.2"));

      examples.push_back(VW980::read_example(*vw, "ccb slot 0:0:0.2 |Slot m"));
      examples.push_back(VW980::read_example(*vw, "ccb slot 1:0:0.25 |Slot n"));
    ...
    // and shuffle order of actions
    {
      ...
      examples.push_back(VW980::read_example(*vw, "ccb shared |A a b"));
      examples.push_back(VW980::read_example(*vw, "ccb action | 1:0.1 2:0.12 3:0.13 b200:2 c500:9"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_7 a_8 a_9 v1:0.99"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_10 a_11 a_12"));
      examples.push_back(VW980::read_example(*vw, "ccb action | a_13 a_14 a_15"));
      ...
      examples.push_back(VW980::read_example(*vw, "ccb slot 0:0:0.2 |Slot l"));
      examples.push_back(VW980::read_example(*vw, "ccb slot 1:0:0.25 |Slot f"));
...
{
  float (*compute_dot_prod_simd)(uint64_t, VW980::workspace*, uint64_t, VW980::example*);
  if (VW980::cb_explore_adf::cpu_supports_avx512())
  {
    compute_dot_prod_simd = VW980::cb_explore_adf::compute_dot_prod_avx512;
  }
  else if (VW980::cb_explore_adf::cpu_supports_avx2())
  {
    compute_dot_prod_simd = VW980::cb_explore_adf::compute_dot_prod_avx2;
  }
  else
  {
...

  {
    ...
    auto vw = VW980::initialize(vwtest::make_args("--cb_explore_adf", "--large_action_space", "--quiet"));
    VW980::multi_ex examples;
    examples.push_back(VW980::read_example(*vw, generate_example(/*num_namespaces=*/2, /*num_features=*/5)));
    auto* ex = examples[0];
    auto interactions =
    ...
    float result_scalar = VW980::cb_explore_adf::compute_dot_prod_scalar(column_index, vw.get(), seed, ex);
  ...
  }
  {
    ...
    auto vw = VW980::initialize(vwtest::make_args("--cb_explore_adf", "--large_action_space", "--quiet"));
    VW980::multi_ex examples;
    examples.push_back(VW980::read_example(*vw, generate_example(/*num_namespaces=*/2, /*num_features=*/50)));
    auto* ex = examples[0];
    auto interactions =
        VW980::details::compile_interactions<VW980::details::generate_namespace_combinations_with_repetition, false>(
            vw->interactions, std::set<VW980::namespace_index>(ex->indices.begin(), ex->indices.end()));
  ...
  }
  {
    ...
    auto vw = VW980::initialize(vwtest::make_args("--cb_explore_adf", "--large_action_space", "--quiet", "-q::"));
    VW980::multi_ex examples;
    examples.push_back(VW980::read_example(*vw, generate_example(/*num_namespaces=*/2, /*num_features=*/5)));
    auto* ex = examples[0];
    auto interactions =
...
{
  const bool cpu_supports_simd = (VW980::cb_explore_adf::cpu_supports_avx512() || VW980::cb_explore_adf::cpu_supports_avx2());
...

  {
    ...
    auto vw_scalar = VW980::initialize(VW980::make_unique<VW980::config::options_cli>(vw_cmd));

    VW980::LEARNER::learner* learner_scalar =
    ...
    VW980::multi_ex ex_scalar;
    for (const auto& example : examples) { ex_scalar.push_back(VW980::read_example(*vw_scalar, example)); }
    vw_scalar->predict(ex_scalar);
    auto& scores_scalar = ex_scalar[0]->pred.a_s;

    vw_cmd.push_back("--las_hint_explicit_simd");
    auto vw_simd = VW980::initialize(VW980::make_unique<VW980::config::options_cli>(vw_cmd));

    VW980::LEARNER::learner* learner_simd =
    ...
    VW980::multi_ex ex_simd;
    for (const auto& example : examples) { ex_simd.push_back(VW980::read_example(*vw_simd, example)); }
  ...
  }
  {
    ...
    auto vw_simd = VW980::initialize(vwtest::make_args(
  ...
  }
  {
    ...
    auto vw_simd = VW980::initialize(vwtest::make_args("--cb_explore_adf", "--large_action_space", "--quiet",
