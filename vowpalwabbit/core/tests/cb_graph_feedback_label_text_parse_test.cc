...
void parse_cb_label(VW980::label_parser& lp, VW980::string_view label, VW980::polylabel& l, VW980::reduction_features& red_features)
{
...
TEST(cb_gf_label_tests, cb_graph_parse_label)
{
  ...
  auto lp = VW980::cb_label_parser_global;
...
TEST(cb_gf_label_tests, throws_w_malformed_triplet)
{
  ...
  auto lp = VW980::cb_label_parser_global;
  VW980::reduction_features red_features;
  EXPECT_THROW(parse_cb_label(lp, "shared graph 0,1,2 0,1,2 5 | s_1 s_2", label, red_features), VW980::vw_exception);
}
...
TEST(cb_gf_label_tests, throws_w_standalone_graph_example)
{
  ...
  auto lp = VW980::cb_label_parser_global;
  VW980::reduction_features red_features;
  EXPECT_THROW(parse_cb_label(lp, "graph 0,1,2 0,1,2 5,5,5 | s_1 s_2", label, red_features), VW980::vw_exception);
}
...
TEST(cb_gf_label_tests, throws_w_graph_in_label)
{
  ...
  VW980::reduction_features red_features;
  EXPECT_THROW(
      parse_cb_label(lp, "0:1.0:0.5 graph 0,1,2 0,1,2 5,5,5  | a_1 b_1 c_1", label, red_features), VW980::vw_exception);
}
