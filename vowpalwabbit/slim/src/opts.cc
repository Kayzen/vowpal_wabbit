...
template void find_opt<std::vector<VW980::namespace_index>>(std::string const& command_line_args, std::string arg_name,
    std::vector<std::vector<VW980::namespace_index>>& out_values);
