#include "vw980_vowpalWabbit_learner_VWMultilabelsLearner.h"
...
JNIEXPORT jobject JNICALL Java_vw980_vowpalWabbit_learner_VWMultilabelsLearner_predict(
...
JNIEXPORT jobject JNICALL Java_vw980_vowpalWabbit_learner_VWMultilabelsLearner_predictMultiline(
