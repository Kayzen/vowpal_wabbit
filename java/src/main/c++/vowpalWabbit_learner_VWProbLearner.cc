#include "vw980_vowpalWabbit_learner_VWProbLearner.h"
...
JNIEXPORT jfloat JNICALL Java_vw980_vowpalWabbit_learner_VWProbLearner_predict(
...
JNIEXPORT jfloat JNICALL Java_vw980_vowpalWabbit_learner_VWProbLearner_predictMultiline(
