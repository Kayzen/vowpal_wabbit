...
JNIEXPORT jint JNICALL Java_vw980_vowpalWabbit_learner_VWMulticlassLearner_predict(
...
JNIEXPORT jint JNICALL Java_vw980_vowpalWabbit_learner_VWMulticlassLearner_predictMultiline(
...
JNIEXPORT jfloatArray JNICALL Java_vw980_vowpalWabbit_learner_VWMulticlassLearner_rawPredict(JNIEnv *env, jobject obj, jstring example_string, jboolean learn, jlong vwPtr)
{
