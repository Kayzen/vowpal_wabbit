#include "vw980_vowpalWabbit_learner_VWScalarLearner.h"
...
JNIEXPORT jfloat JNICALL Java_vw980_vowpalWabbit_learner_VWScalarLearner_predict(
...
JNIEXPORT jfloat JNICALL Java_vw980_vowpalWabbit_learner_VWScalarLearner_predictMultiline(
