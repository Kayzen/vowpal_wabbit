...
extern "C"
{
  ...
  API VW980::experimental::api_status* CreateApiStatus();
  API void DeleteApiStatus(VW980::experimental::api_status* status);
  ...
  API const char* GetApiStatusErrorMessage(VW980::experimental::api_status* status);
  API int GetApiStatusErrorCode(VW980::experimental::api_status* status);
