...
API float GetPredictionScalar(VW980::example* ex) { return ex->pred.scalar; }
...
API size_t GetPredictionScalarsCount(VW980::workspace* vw, VW980::example* ex) { return ex->pred.scalars.size(); }
...
API float GetPredictionProb(VW980::workspace* vw, VW980::example* ex) { return ex->pred.prob; }
...
API uint32_t GetPredictionMulticlassClass(VW980::workspace* vw, VW980::example* ex) { return ex->pred.multiclass; }
...
API size_t GetPredictionActionScoresCount(VW980::workspace* vw, VW980::example* ex) { return ex->pred.a_s.size(); }
...
API size_t GetPredictionTopicProbsCount(VW980::workspace* vw, VW980::example* ex) { return static_cast<size_t>(vw->lda); }
